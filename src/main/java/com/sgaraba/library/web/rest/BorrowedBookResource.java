...
public class BorrowedBookResource {
    ...
    public ResponseEntity<List<BorrowedBookDTO>> getAllBorrowedBooks(
        ...
        log.debug("REST request to get BorrowedBooks by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countBorrowedBooks(BorrowedBookCriteria criteria) {
        log.debug("REST request to count BorrowedBooks by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
