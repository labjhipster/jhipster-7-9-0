...
public class ClientResource {
    ...
    public ResponseEntity<List<ClientDTO>> getAllClients(
        ...
        log.debug("REST request to get Clients by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countClients(ClientCriteria criteria) {
        log.debug("REST request to count Clients by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
